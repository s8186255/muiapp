...
var mui = (function(document, undefined) {
	...
	$.isPlainObject = function(obj) {
		return typeof obj != 'undefined' && $.isObject(obj) && !$.isWindow(obj) && Object.getPrototypeOf(obj) === Object.prototype;
	};
	/**
	 * mui isFunction
	 */
...
//		if (detail.angle > -20 && detail.angle < 20 && $.options.swipeBack === true) {
//			$.back();
//		}
...
(function($, window, name) {
	...
	// 因为switch是关键词，导致低端Android机的浏览器报错，这里临时前面加了个'_'
	// by vivi 2015-01-13 12:20
	$.fn._switch = function(options) {
		var switchApis = [];
		this.each(function() {
			var switchApi = null;
			...
			if (target.classList) {
				...
				if (classList.contains(CLASS_TABLE_VIEW_CELL)) {
					...
					if (!isDisabled) {
						...
						if (!(cell.querySelector('input') || cell.querySelector('.' + CLASS_TOGGLE))) {
							toggleActive(true);
						}
					}
					break;
