/*
 * Jingle v0.4 C
 * opyright (c) 2013 shixy, http://shixy.github.io/Jingle/
...
J.Page = (function($){
    ...
    var loadSectionTpl = function(hash,callback){
       ...
       // J.settings.showPageLoading && J.fuuWaiting();
       J.settings.showPageLoading;
        
        //fuu section的加载操作，仔细理解一下
        //必要时直接调用
...
J.Popup = (function($){
	...
	//fuu popup的show函数，仔细看看，如何控制转场无延迟
	//fuu 非常重要
